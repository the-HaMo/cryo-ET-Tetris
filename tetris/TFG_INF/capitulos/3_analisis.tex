...
\begin{enumerate}
    ...
    El experimento se realizó sobre un volumen de $500\times500\times250$ vóxeles con la proteína \textit{2uv8\_10A.pns}, alcanzando un grado de ocupancia del \textbf{32\%} con \textbf{2\,552 monómeros insertados} en un tiempo total de \textbf{318.05\,s}. La Figura~\ref{fig:profile-breakdown} muestra la curva de ocupancia frente al tiempo, con el área bajo la curva coloreada según la etapa dominante en cada tramo.
    ...
    \hline
    Selección de semilla (\texttt{pick\_seed}) & 108.55 & 34.1\% \\
    Correlación FFT 3D & 85.87 & 27.0\% \\
    Validación e inserción & 60.75 & 19.1\% \\
    Otros (Python, I/O) & 55.67 & 17.5\% \\
    Generación \textit{in-shell} & 4.13 & 1.3\% \\
    Rotación afín & 3.18 & 1.0\% \\
    \hline
    \textbf{Total} & \textbf{318.05} & \textbf{100\%} \\
    \hline
    \end{tabular}
